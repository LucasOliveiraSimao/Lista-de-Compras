...
////        clickListItem(R.id.rv_list_purchases, 0)
//    }
//
//    @Test
//    fun shouldDisplayWarningMessage_whenProductNameFieldIsEmpty() {
////        clickListItem(R.id.rv_list_purchases, 0)
////        clearText(R.id.update_purchase_name)
////        clearText(R.id.update_purchase_quantity)
////        clearText(R.id.update_purchase_price)
////        clickOn(R.id.update_btn_insert)
...
////        clickListItem(R.id.rv_list_purchases, 0)
////        writeTo(R.id.update_purchase_name, "  ")
////        clearText(R.id.update_purchase_quantity)
////        clearText(R.id.update_purchase_price)
////        clickOn(R.id.update_btn_insert)
////        assertDisplayed(R.string.warning_message)
...
////        clickListItem(R.id.rv_list_purchases, 0)
////        writeTo(R.id.update_purchase_quantity, "  ")
////        clearText(R.id.update_purchase_price)
////        clickOn(R.id.update_btn_insert)
////        assertDisplayed(R.string.warning_message)
//    }
...
////        clickListItem(R.id.rv_list_purchases, 0)
////        writeTo(R.id.update_purchase_price, "  ")
////        clickOn(R.id.update_btn_insert)
////        assertDisplayed(R.string.warning_message)
//    }
//
